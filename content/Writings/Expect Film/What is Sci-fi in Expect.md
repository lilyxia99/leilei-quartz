...
The definition of Sci-fi in this paper will focus more on the sci-fi works that reveal the picture of a society or a portrait of a person living in a society under the development of technology or ideology. Works like *Brave New World*, *Neuromancer* and  *Pantheon* would fall into that category. In these works, what satisfies and resonate the author and the readers is actually the display of our current ideology or the value judgement, although mediated through an alternative universe or time era so that it doesn't feel too frightening. 
