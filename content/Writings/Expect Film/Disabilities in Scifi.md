...
Following these purpose, I decided to use role-playing in VR to conduct the research. 
...
More importantly, shooting in VR would change the documentary aspect of the film "dramatically" (literally).

On the other hand, however, VR brings its own problems. The technical limitations, high costs, and a lack of widespread content makes VR a perpetually unfulfilled promise, a illusion shattering process we also experienced in the shooting process. The current VR technology has so many bug and unreasonable things: The inaccessible design of VR headset, the constant bugs of device that arise out of nowhere, the Internet firewalls between China and US, the bad user experience of the account system, the fatigue from looking at the extreme close screen...... All those process becomes the best real life parallel of how technology, while providing some convenience, creates even more troubles and often doesn't take the need from people with disabilities into account.

While the device reflects the failure of technology, the virtual set up for VR also reflects the lack of consideration for disabilities. There is no existing instruction on how to design a wheelchair chair character, and I have to figure out a work around which is imperfect in fitting with the the VRChat system. The process and tutorial for how to create an accessible VR environment are included in the film, pointing back to the concept the mixing of fiction and reality.
...
while being shot in VR, the final product is a single channel film piece. 
